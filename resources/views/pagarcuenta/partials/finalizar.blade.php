<header>
    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
        {{ __('Finalizar factura de la cuenta por pagar') }}
    </h2>
    <p>
        Información previa
    </p>
    <div class="grid gap-6 mb-6 md:grid-cols-3">
        <div>
            ...
            <x-text-input disabled id="monto_pagado" type="number" class="mt-1 block w-full" :value=" old('monto_pagado', $pagarcuenta->monto_pagado) " />
        </div>
        <div>
