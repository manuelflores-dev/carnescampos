            ...
            <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-red-600	flex flex-wrap items-center text-lg justify-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('pagarcuenta.pdf', ['tipo' => 'todas'])">
                                Todas
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('pagarcuenta.pdf', ['tipo' => 'pendientes'])">
                                Pendientes
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('pagarcuenta.pdf', ['tipo' => 'pagadas'])">
                                Pagadas
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
