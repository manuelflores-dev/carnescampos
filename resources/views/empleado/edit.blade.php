<x-app-layout>
    <x-slot name="header">
        <div class="container mx-auto flex flex-wrap p-1 flex-col md:flex-row items-center">
            <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                ...
                <span class="ml-3 text-2xl">Empleado</span>
            </a>
            <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-red-600	flex flex-wrap items-center text-lg justify-center">
                ...
                <a class="mr-5 hover:text-red-600" href="{{ $empleado->id }}/recorridos">Todos los recorridos de este empelado</a>
            </nav>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow-2xl  shadow-red-600/40 sm:rounded-3xl">
                <div class="">
                    @include('empleado.partials.update')
                </div>
            </div>

            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow-2xl  shadow-red-600/40 sm:rounded-3xl">
                <div class="max-w-xl">
                    @include('empleado.partials.delete')
                </div>
            </div>
        </div>
    </div>
