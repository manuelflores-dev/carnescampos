<x-app-layout>
    <x-slot name="header">
        <div class="container mx-auto flex flex-wrap p-1 flex-col md:flex-row items-center">
            ...
            <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-red-600	flex flex-wrap items-center text-lg justify-center">
                ...
                <a class="mr-5 hover:text-red-600" href="{{ route('cobrarcuentas.cliente', ['id' => $cobrarcuenta->cliente->id])}}">Todos las facturas de este cliente</a>
            </nav>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow-2xl sm:rounded-3xl">
                <div class="max-w-xl">
                    @include('cobrarcuenta.partials.delete')
                </div>
            </div>
        </div>
    </div>
