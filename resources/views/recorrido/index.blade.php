            ...
            <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-red-600	flex flex-wrap items-center text-lg justify-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('recorrido.pdf', ['tipo' => 'todos'])">
                                Todos
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('recorrido.pdf', ['tipo' => 'en-ruta'])">
                                En ruta
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('recorrido.pdf', ['tipo' => 'terminados'])">
                                Terminados
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
